...
function run() {
  ...
  const thresholds = getThresholdConfig(config);
...
function getThresholdConfig(config) {
  return config.LIGHTHOUSE_OPTS.config.hasOwnProperty('thresholds') ? config.LIGHTHOUSE_OPTS.config.thresholds : null;
}
